...
class CinemasList extends PureComponent {
  ...
  handleCinemaItemClick = event => {
    ...
    if (cinema.selectedCinema)
      if (selectedId === cinema.selectedCinema._id) return;
  ...
  render() {
    ...
    return (
      <div className="cinema-content">
        ...
        {!this.state.isListVisible ? null : cinema.isFetching ? (
          <FilmLoading />
        ) : (
          <Fragment>
            <div
              className="cinema-content-list"
              onClick={this.handleCinemaItemClick}
            >
